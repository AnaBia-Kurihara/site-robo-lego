...
- **Design do robô** — Conceito visual, objetivo do projeto e diferenciais de design (peças em relevo, cores vivas, formas modulares).
- **Ver projeto (Engenharia)** — Detalhes técnicos: sistema de movimento (rodas motoras + roda boba), sensores (8 sensores laterais) e controle via Bluetooth pelo celular.
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/AnaBia-Kurihara/site-robo-lego.git
   ```
2. Abra o arquivo `index.html` diretamente no navegador.

> Não é necessário nenhum servidor ou instalação adicional — é um site estático.
